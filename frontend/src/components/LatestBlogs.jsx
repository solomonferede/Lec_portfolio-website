...
export default function LatestBlogs() {
  ...
  return (
    <section id="latest-blogs" className="section section-reveal" ref={sectionRef}>
      <div className={isRevealed ? 'revealed' : ''}>
        <div className="flex items-end justify-between mb-6">
          <div>
            <h2 className="section-heading">Latest Blog Posts</h2>
            <p className="mt-2 text-slate-500 dark:text-slate-400">Recent articles and insights</p>
          </div>
          <Link to="/blog" className="text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-50 hover:underline transition-colors">
            View all
          </Link>
        </div>
